<script setup lang="ts">
    ...
    import { ref, computed, reactive, callWithAsyncErrorHandling } from 'vue'
    ...
    //função utilizando Async/Await e Try/Catch
    // const submitLogin = async() =>{
    //     console.log('trying to login with crdentials below:', credentials)
    //     try{
    ...
    //função utilizando PROMISE THEN/CATCH
    const submitLogin = () =>{
        console.log('trying to login with crdentials below:', credentials)
